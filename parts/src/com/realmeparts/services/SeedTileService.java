...
public class SeedTileService extends TileService {
    ...
    @Override
        public void onStartListening() {
            ...
            currentState = sharedPrefs.getInt (DeviceSettings.KEY_SEED, 0);
            Tile tile = getQsTile();
    ...
    @Override
        public void onClick() {
            SharedPreferences sharedPrefs = PreferenceManager.getDefaultSharedPreferences(this);
            currentState = sharedPrefs.getInt (DeviceSettings.KEY_SEED, 0);
            int currentState = sharedPrefs.getInt (DeviceSettings.KEY_SEED, 0);
        ...
        Tile tile = getQsTile();
        sharedPrefs.edit().putInt(DeviceSettings.KEY_SEED, nextState).commit();
